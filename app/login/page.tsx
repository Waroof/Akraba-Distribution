      ...
      <div className="w-full max-w-md">
        <div className="flex justify-center mb-4">
          <div className="flex items-center">
            <Truck className="h-12 w-12 text-red-700" />
            <span className="ml-2 text-2xl font-bold text-gray-800">Akraba Distribution</span>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-gray-600">Account Opening Inquiries – Info@capitalcsc.com</p>
        </div>
      </div>
    </div>
  )
